...
export default function ChangeStrategyModal({ 
    ...
    return (
        ...
        className="open:flex open:flex-col open:justify-center open:items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-90 border-green-400 rounded-2xl w-[70vw] h-[70vh] bg-zinc-900 border-[3px] font-['Inter']">
            ...
            <div className="pt-[2vw] items-center justify-center text-gray-200 text-5xl font-normal font-['Inter']">Change Active<span className="text-green-400"> Algorithm</span></div>
            <div className="flex pt-[2vw]">
                <label>
                <div className="items-center text-gray-200 text-2xl font-normal font-['Inter'] pt-[0.5vw] pr-[0.5vw]">Name:</div>
                <select
                    ref={selectRef}
                    type="value"
