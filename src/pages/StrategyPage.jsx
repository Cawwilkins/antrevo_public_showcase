    ...
    return (
        <main className="relative w-full min-h-screen overflow-x-hidden bg-[#1a1a1a] font-['Inter']">
            ...
            <button 
                ...
                className="md:hidden flex mx-auto py-[6vw] px-[4vw] items-center text-2xl text-gray-200 mt-[10vw] border-[3px] h-[2vh] rounded-2xl border-green-400 font-bold hover:bg-green-400 hover:text-zinc-900 transition-colors duration-200">
                Change&nbsp;Strategy
            </button>
            {showStrategyModal && (
                <ChangeStrategyModal 
        ...
        <div className="flex flex-col pl-[7vw] mt-[2vw] md:mt-[0vw] pt-[3vw] pr-[4vw] md:pr-[0vw]">
                <div className="flex gap-[2vw]">
                    <div className="flex flex-col">
                        <p className="text-left text-gray-200 font-bold text-2xl md:text-4xl">Strategy: <span className="text-green-400 italic">{algo || "Unknown"}</span></p>
                        <p className="text-left pl-[1vw] pt-[0.5vw] text-gray-200 font-semibold md:text-2xl">Concept:</p>
                        <p className="text-left pl-[2vw] pt-[0.5vw] text-zinc-500 md:text-2xl">{engine?.strategy_info?.concept || "Unknown"}</p>
                        <p className="text-left pl-[1vw] pt-[2vw] text-gray-200 font-semibold md:text-2xl">Strengths:</p>
                        <p className="text-left pl-[2vw] pt-[0.5vw] text-zinc-500 md:text-2xl">
                            <ul>
                    ...
                    <button 
                        onClick={() => setShowStrategyModal(true)}
                        className="hidden md:block text-gray-200 text-2xl mt-[10vw] border-[3px] ml-[15vw] mr-[10vw] h-[2vh] pr-[4vw] pt-[2vw] pl-[4vw] pb-[4vw] rounded-2xl border-green-400 font-bold hover:bg-green-400 hover:text-zinc-900 transition-colors duration-200">
                        Change&nbsp;Strategy
                    </button>
                    {showStrategyModal && (
                        <ChangeStrategyModal 
                 ...
                 <div className="flex flex-col mt-[4vw]">
                        <p className="text-left text-green-400 font-bold text-2xl md:text-4xl">Algorithm</p>
                        <p className="text-left pl-[2vw] pt-[0.5vw] text-zinc-500 md:text-2xl">
                            <ul>
